...
```bash
pnpm dlx skills add alessandrocurcu/skills --skill='*' -g
```
...
- Vuoi aggiungere una nuova skill? Inizia modificando [meta.ts](./meta.ts) per aggiungere un nuovo vendor o una nuova skill scritta a mano
